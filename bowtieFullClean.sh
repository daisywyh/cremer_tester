...
snakemake --snakefile workflow/rules/prefetchDump.smk --delete-all-output
...
snakemake --snakefile workflow/rules/runIndex.smk --delete-all-output

echo "run runActualBowtie.smk ((ε(*´･ω･)っ†*ﾟ¨ﾟﾟ･*:..☆"
snakemake --snakefile workflow/rules/runActualBowtie.smk --delete-all-output

echo "run summarise.smk ᕕ(⌐■_■)ᕗ ♪♬"
snakemake --snakefile workflow/rules/summarise.smk --delete-all-output

echo "run finalCleanup.smk ｡+.｡☆ﾟ:;｡+ﾟ ☆*ﾟ¨ﾟﾟ･*:..ﾞ((ε(*⌒▽⌒)†"
snakemake --snakefile workflow/rules/finalCleanup.smk --delete-all-output
