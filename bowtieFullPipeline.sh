...
snakemake --snakefile workflow/rules/prefetchDump.smk --cores $NUMCORES --forceall & disown
...
snakemake --snakefile workflow/rules/runIndex.smk --cores $NUMCORES --forceall & disown

echo "run runActualBowtie.smk ((ε(*´･ω･)っ†*ﾟ¨ﾟﾟ･*:..☆"
snakemake --snakefile workflow/rules/runActualBowtie.smk --cores $NUMCORES --forceall & disown

echo "run summarise.smk ᕕ(⌐■_■)ᕗ ♪♬"
snakemake --snakefile workflow/rules/summarise.smk --cores $NUMCORES --forceall & disown

echo "run finalCleanup.smk ｡+.｡☆ﾟ:;｡+ﾟ ☆*ﾟ¨ﾟﾟ･*:..ﾞ((ε(*⌒▽⌒)†"
snakemake --snakefile workflow/rules/finalCleanup.smk --cores $NUMCORES --forceall & disown
