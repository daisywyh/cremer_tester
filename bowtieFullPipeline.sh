...
snakemake --snakefile workflow/rules/prefetchDump.smk --cores $NUMCORES --forcerun
...
snakemake --snakefile workflow/rules/runIndex.smk --cores $NUMCORES --forcerun

echo "run runActualBowtie.smk ((ε(*´･ω･)っ†*ﾟ¨ﾟﾟ･*:..☆"
snakemake --snakefile workflow/rules/runActualBowtie.smk --cores $NUMCORES --forcerun

echo "run summarise.smk ᕕ(⌐■_■)ᕗ ♪♬"
snakemake --snakefile workflow/rules/summarise.smk --cores $NUMCORES --forcerun

echo "run finalCleanup.smk ｡+.｡☆ﾟ:;｡+ﾟ ☆*ﾟ¨ﾟﾟ･*:..ﾞ((ε(*⌒▽⌒)†"
snakemake --snakefile workflow/rules/finalCleanup.smk --cores $NUMCORES --forcerun
