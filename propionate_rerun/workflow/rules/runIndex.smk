...
rule buildIndex:
    input:
        "propionate_rerun/workflow/out/gene_catalogues/{overall_pathway}_compiled_gene_catalogue_editIDs_noDups.fa"
    params:
    ...
    shell:
        """
        bowtie2-build -f {input} propionate_rerun/workflow/out/index/{params.index_name}_gene_catalogue
        """
